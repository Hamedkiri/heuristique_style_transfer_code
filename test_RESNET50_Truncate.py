...
def main():
    ...
    parser.add_argument('--mode', choices=['classification', 'tsne', 'tsne_interactive', 'camera', 'inference', 'clustering'], default='classifier', help='Mode d\'opération')
    ...
    # Déterminer les noms des classes
    if args.classes:
        class_names = args.classes
    elif 'classes' in best_config:
